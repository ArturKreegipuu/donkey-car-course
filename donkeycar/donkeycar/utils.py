...
def get_model_by_type(model_type: str, cfg: 'Config') -> Union['KerasPilot', 'FastAiPilot']:
    ...
    from donkeycar.parts.keras import KerasCategorical, KerasLinear, \
        ...
        KerasLSTM, Keras3D_CNN, KerasLinearCropped, KerasLinearSlow
    ...
    elif used_model_type == 'cropped':
        kl = KerasLinearCropped(interpreter=interpreter, input_shape=input_shape)
    elif used_model_type == 'slow':
        kl = KerasLinearSlow(interpreter=interpreter, input_shape=input_shape)
